...
function petRandom(petData) {
  ...
  var petInfo = `<div class="pet-info-wrapper"><ul><li>${pronoum}</li> <li>${description} </li><li>Location: ${petData.city}, ${petData.state}</li> <li><button type="button" class="button" onclick="petToggle()">Click for more information</button></li></ul></div>`
